...
estimated_params;
  ...
  // Persistence
  rho_US  , beta_pdf , 0.6 , 0.4;
  rho_CN  , beta_pdf , 0.6 , 0.4;
  rho_dol , beta_pdf , 0.6 , 0.4;
  ...
  varrho_US , beta_pdf   , 0.4 , 0.3;
  varrho_CN , beta_pdf   , 0.4 , 0.3;
...
// Bayesian estimation
// -------------------------
estimation(datafile='data_6.m', mh_replic=500, mh_nblocks=2, mh_drop=0.3, diffuse_filter, mode_check, mode_compute=6,bayesian_irf);
